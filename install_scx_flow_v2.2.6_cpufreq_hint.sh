...
BUILD_DIR="/tmp/scx-flow-v2.2.6-cpufreq-build"
INSTALL_PATH="/usr/bin/scx_flow"
FORK_BRANCH="scx_flow_v2_2_6_cpufreq_hint"
...
step "Cloning scx_flow v2.2.6 with cpufreq hint (PR #3608)"
...
rm -rf "$BUILD_DIR"
echo ""
echo "=== scx_flow v2.2.6 + cpufreq hint (PR #3608) installed ==="
