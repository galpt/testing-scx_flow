...
BUILD_DIR="/tmp/scx-flow-build"
INSTALL_PATH="/usr/bin/scx_flow"
UPSTREAM_REPO="https://github.com/sched-ext/scx.git"
...
rm -rf "$BUILD_DIR"
echo ""
echo "=== scx_flow installed (latest from upstream main) ==="
