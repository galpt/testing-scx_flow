...
| **Score interaction bugs.** 13 wake_profile bits, 3 starvation counters, 4 burst limits — changing one threshold cascades unpredictably. | **No heuristic counters.** One DSQ, one slice, one budget signal. No starvation counters, no anti-starvation rescue, no burst limits. (Diagnostic monitor counters are retained for observability.) |
