...
BUILD_DIR="/tmp/scx-flow-v3.0.4-cherrypick-build"
INSTALL_PATH="/usr/bin/scx_flow"
FORK_BRANCH="scx_flow-v3.0.4-cherrypick"
...
step "Cloning scx_flow v3.0.4-cherrypick"
...
rm -rf "$BUILD_DIR"
echo ""
echo "=== scx_flow v3.0.4-cherrypick installed ==="
